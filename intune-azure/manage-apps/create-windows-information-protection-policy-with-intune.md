...
-   [MAM sağlayıcınızı Intune ile yapılandırma](https://docs.microsoft.comget-ready-to-configure-app-protection-policies-for-windows-10.md) hakkında daha fazla bilgi edinin.
