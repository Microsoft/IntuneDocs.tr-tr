---
title: "Uygulama koruma ilkelerini izleme | Intune Azure önizlemesi | Microsoft Docs"
...
**Azure’de Intune önizlemesinde değilseniz**, bu konu başlığı altında klasik Intune konsolunda [uygulama koruma ilkelerinin nasıl oluşturulacağı](https://docs.microsoft.com/en-us/intune/deploy-use/create-and-deploy-mobile-app-management-policies-with-microsoft-intune) anlatılır.
...
4. **Uygulamaları yönet** iş yükünde, özet görünümü görmek için **İzle** > **Uygulama koruma kullanıcı durumu**’nu seçin:
