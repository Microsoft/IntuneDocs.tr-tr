---
title: "Uygulama koruma ilkelerini oluşturma ve dağıtma | Intune Azure önizlemesi | Microsoft Docs"
...
**Azure Portal önizleme programındaki Intune hizmetinde değilseniz**, bu konu başlığı altında klasik Intune konsolunda [uygulama koruma ilkelerinin nasıl oluşturulacağı](https://docs.microsoft.com/en-us/intune/deploy-use/create-and-deploy-mobile-app-management-policies-with-microsoft-intune) anlatılır.
...
1.  **Uygulamaları yönet** iş yükünde **Yönet** > **Uygulama koruma ilkeleri**’ni seçin.
