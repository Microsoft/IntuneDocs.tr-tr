...
Profili gerekli iOS cihazlara atayın. Daha fazla bilgi için [Cihaz profillerini atama](../configure-devices/how-to-assign-device-profiles.md) kısmındaki adımları kullanın.
