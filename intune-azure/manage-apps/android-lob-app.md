---
title: "Android iş kolu uygulamalarını Intune’a ekleme | Intune Azure önizlemesi | Microsoft Docs"
description: "Intune Azure önizlemesi: Android iş kolu uygulamalarını Intune’a eklemeyi öğrenin."
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
# <a name="how-to-add-android-line-of-business-lob-apps-to-intune"></a>Android iş kolu (LOB) uygulamalarını Intune’a ekleme
...
**Kurulum dosyası seçin** dikey penceresinde göz at düğmesine tıklayarak Android uygulaması kurulum dosyasına (.apk uzantılı) gidin ve **Tamam**’a tıklayın.
