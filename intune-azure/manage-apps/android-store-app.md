---
title: "Android mağaza uygulamalarını Intune’a ekleme | Intune Azure önizlemesi | Microsoft Docs"
...
# <a name="how-to-add-android-store-apps-to-intune"></a>Android mağaza uygulamalarını Intune’a ekleme
...
7. **Uygulamayı Düzenle** dikey penceresinde aşağıdaki bilgileri yapılandırın. Bitirdiğinizde, **Ekle**’ye tıklayın. Seçtiğiniz uygulamaya bağlı olarak, dikey penceredeki değerlerden bazıları otomatik olarak doldurulmuş olabilir:
    ...
    - **Minimum İşletim Sistemi** - Listeden uygulamanın yüklenebileceği minimum işletim sistemi sürümünü seçin. Uygulamayı daha önceki bir işletim sistemi çalıştıran cihazlara atarsanız, uygulama yüklenmez.
