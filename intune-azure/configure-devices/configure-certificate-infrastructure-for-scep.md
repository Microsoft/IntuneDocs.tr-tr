---
title: "SCEP için sertifika altyapısını yapılandırma | Intune Azure önizlemesi | Microsoft Docs"
description: "Intune Azure önizlemesi: Intune SCEP sertifika profillerini oluşturmadan ve dağıtmadan önce altyapınızı yapılandırmayı öğrenin."
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
---
# <a name="configure-certificate-infrastructure-for-scep-in-intune-azure-preview"></a>Intune Azure önizlemesinde SCEP için sertifika altyapısını yapılandırma
...
### <a name="a-namebkmkcertsandtemplatesacertificates-and-templates"></a><a name="BKMK_CertsAndTemplates"></a>Sertifikalar ve Şablonlar
...
### <a name="a-namebkmkaccountsaaccounts"></a><a name="BKMK_Accounts"></a>Hesaplar

|Ad|Ayrıntılar|
|--------|-----------|
|**NDES hizmet hesabı**|NDES Hizmet Hesabı olarak kullanılacak bir etki alanı kullanıcı hesabı belirtirsiniz.|

## <a name="a-namebkmkconfigureinfrastructureaconfigure-your-infrastructure"></a><a name="BKMK_ConfigureInfrastructure"></a>Altyapınızı yapılandırın
...
Artık, [Sertifika profillerini yapılandırma](how-to-configure-certificates.md) konusunda açıklandığı gibi sertifika profillerinizi yapılandırmaya hazırsınız.
