...
BT yöneticileri, uygulamadaki web bağlantılarının [Intune Managed Browser uygulaması](../deploy-use/manage-internet-access-using-managed-browser-policies.md) ile açılmasını zorunlu hale getirebilir. Bu, şirket ortamında görünen bağlantıların Intune tarafından yönetilen uygulamaların etki alanı içinde kalmasını sağlar.
...
>[!IMPORTANT]
>Cihaz kaydı olmadan Intune uygulama koruması henüz Android için Intune Uygulama SDK'sında kullanılmamaktadır. Intune Uygulama Sarmalama Araçları, iOS için SDK, Xamarin Bileşeni ve SDK Cordova Eklentisi için kullanılabilir.
