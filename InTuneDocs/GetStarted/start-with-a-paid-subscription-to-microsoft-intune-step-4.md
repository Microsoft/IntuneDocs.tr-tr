...
Kullanıcıların Intune hizmetini kullanmak veya cihazlarını yönetime kaydetmek üzere oturum açabilmeleri için bu kullanıcılara [Office 365 portalı](http://go.microsoft.com/fwlink/p/?LinkId=698854) içinden Intune aboneliğinize yönelik bir lisans atanması gerekir. Kendilerine lisans atandıktan sonra kullanıcıların adları Intune Yönetim konsolunda görünür. Kullanıcılar daha sonra beş adede kadar cihazı kaydedebilir.
...
2.  Intune kullanıcı lisansı atamak istediğiniz kullanıcı hesabını ve kullanıcı hesap özelliklerinde **Microsoft Intune**’u seçin.
...
### Sonraki adımlar
Tebrikler! *Intune hızlı başlangıç kılavuzunun* 4. adımını tamamlamış oldunuz.
