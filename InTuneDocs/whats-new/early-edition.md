...
Windows 10 Şirket Portalı uygulamasında artık Şirket Portalı uygulamasından başlatılan tüm modern uygulama yüklemelerinin ilerleme durumu gösterilecek. Windows 10 için Şirket Portalı uygulamasının yeni durum iletilerini [Intune uygulama arabirimindeki yenilikler sayfasında](whats-new-in-intune-app-ui.md) görebilirsiniz.
