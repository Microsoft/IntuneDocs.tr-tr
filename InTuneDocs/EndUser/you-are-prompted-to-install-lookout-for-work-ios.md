---
title: "iOS cihazınıza Lookout for Work uygulamasını yüklemeniz istendi | Microsoft Docs"
description: 
keywords: 
author: barlanmsft
ms.author: barlan
...
# <a name="you-are-prompted-to-install-lookout-for-work-on-your-ios-device"></a>iOS cihazınızda Lookout for Work uygulamasını yüklemeniz istendi
...
1.  Aşağıdaki istemi görürseniz, cihazınıza Lookout for Work yüklenmesine izin vermek için **Yükle**’ye dokunun.
    ...
    ![Lookout for Work yüklemek için yükle öğesine dokunun](./media/ios-lfw-install-app-request.png)
