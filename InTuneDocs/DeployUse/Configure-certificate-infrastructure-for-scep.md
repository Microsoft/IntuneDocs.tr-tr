...
## Sonraki adımlar
Artık, [Sertifika profillerini yapılandırma](Configure-Intune-certificate-profiles.md) konu başlığı altında açıklandığı gibi sertifika profillerini yapılandırmaya hazırsınız.
