...
|**Minimum parola uzunluğu**|Parola için minimum uzunluğu belirtin (**4**-**14** karakter) .|
|**Basit parolalara izin ver**|**0000** veya **1234** gibi basit parolaların kullanımına izin verin.|
|**Parola gerekmeden önce etkin olmama süresi (dakika)**|Bilgisayarın ne kadar süreyle etkinlik dışı kaldıktan sonra kilidinin açılması için bir parolanın gerekli olacağını belirtin.|
|**Parola geçerlilik süresi (gün)**|Kullanıcının kaç gün geçtikten sonra parolayı değiştirmesi gerekeceğini belirtin (**1**-**255** gün).|
