...
## Windows Güvenlik Duvarı'nı yönetmek için Intune ilkelerini kullanma
...
## Windows Güvenlik Duvarı için ilke ayarları belirtme
...
### Önceden tanımlanmış özel durumlar yapılandırma
...
|**Güvenli Soket Tünel Protokolü**|Güvenli Yuva Tünel Protokolü (SSTP) ile yönetilen bilgisayarlara gelen VPN bağlantılarına olanak tanır. Bu ayar HTTPS kullanır.|
