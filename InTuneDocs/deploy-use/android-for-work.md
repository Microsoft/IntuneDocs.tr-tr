...
[İş için Android kaydını etkinleştirme](https://docs.microsoft.com/intune/deploy-use/set-up-android-for-work)

[Android for Work için uygulama dağıtma](https://docs.microsoft.com/intune/deploy-use/android-for-work-apps)
