...
## [Dağıtım planlama, tasarım ve uygulama](plan-design/introduction.md)
...
## [Geçiş](plan-design/intune-mdm-migration-guide.md)
### [1. Aşama: Intune için MDM’e yönelik hazırlıkları yapma](plan-design/migration-phase1-prepare-intune-for-mobile-device-management.md)
#### [Temel kurulum](plan-design/migration-phase1-basic-setup.md)
#### [Mobil cihaz ve uygulama yönetimi ilkelerini yapılandırma](plan-design/migration-phase1-configure-device-and-app-management-policies.md)
#### [Uygulama koruma ilkelerini yapılandırma](plan-design/migration-phase1-configure-app-protection-policies.md)
#### [Geçiş konusunda dikkat edilmesi gereken önemli noktalar](plan-design/migration-phase1-special-migration-considerations.md)
### [2. Aşama: Geçiş kampanyası](plan-design/migration-phase2-migration-campaign.md)
#### [İletişim planı](plan-design/migration-phase2-communication-plan.md)
#### [Sürücü benimseme](plan-design/migration-phase2-drive-end-user-adoption-with-conditional-access.md)
#### [Normal geçiş süreci](plan-design/migration-phase2-typical-migration-cycle.md)
