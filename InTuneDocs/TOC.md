...
### [İş kolu uygulamalarını dışarıdan yükleme](deploy-use/sideload-apps-for-windows.md)
...
#### [MAM ilkelerini yapılandırmaya hazırlanma](deploy-use/get-ready-to-configure-mobile-app-management-policies-with-microsoft-intune.md)
#### [MAM ilkelerini oluşturma ve dağıtma](deploy-use/create-and-deploy-mobile-app-management-policies-with-microsoft-intune.md)
#### [Android için MAM ilkeleri](deploy-use/android-mam-policy-settings.md)
#### [iOS için MAM ilkeleri](deploy-use/ios-mam-policy-settings.md)
#### [MAM ilkelerini doğrulama](deploy-use/validate-mobile-application-management.md)
#### [İlke uyumluluğunu izleme](deploy-use/monitor-mobile-app-management-policies-with-microsoft-intune.md)
