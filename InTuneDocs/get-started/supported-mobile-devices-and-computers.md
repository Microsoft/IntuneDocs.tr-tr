...
description: "Intune çalıştırabilen desteklenen cihaz ve tarayıcıları listeler"
keywords: 
author: nathbarn
ms.author: nathbarn
manager: angrobe
...
# <a name="supported-devices-and-web-browsers-for-intune"></a>Intune için desteklenen cihazlar ve web tarayıcıları

Bir Intune yöneticisi olarak, bir web tarayıcısından geniş bir yelpazedeki cihazları yönetebilirsiniz. Bu konu şunları sağlar:

- [Desteklenen cihaz platformları listesi](#intune-supported-devices)
...
Bir [Intune yazılım istemcisi](/intune/deploy-use/manage-windows-pcs-with-microsoft-intune) alternatif bir kayıt yöntemi olarak Windows bilgisayarlara dağıtılabilir ve yüklenebilir. Intune yazılım istemcisini Windows 10 Home edition hariç, Windows 7 ve üzeri bilgisayarları yönetmek için kullanabilirsiniz. Bilgisayarları istemci yazılımıyla yönetmek [bu özelliklerden](windows-pc-management-capabilities-in-microsoft-intune.md) yararlanmanızı sağlar.
...
>[&larr; **Önkoşullar**](what-to-know-before-you-start-microsoft-intune.md)     [**Ağ oluşturma** &rarr;](network-bandwidth-use.md)  
