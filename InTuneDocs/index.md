...
description: "Microsoft Intune (FIXME) kullanmayı öğrenme"
...
<div class="container">
    ...
    <ul class="pivots">
        <li>
            <a href="#manage">Yönetim</a>
            <ul id="manage">
                <li>
                    <a href="#manage-featured">Öne çıkan makaleler</a>
                    <ul id="manage-featured" class="cardsC">
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Popüler makaleler</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Önerilen makaleler</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">Yeni makaleler</h3>
                            </div>
                        </li>
                        <li>
                            <div class="cardSize">
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="https://graph.microsoft.io/en-us/docs/api-reference/beta/resources/intune_graph_overview">Microsoft Graph'ta Intune ile çalışma</a></h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="https://docs.microsoft.com/en-us/enterprise-mobility-security/solutions/enterprise-mobility-fasttrack-program">150'den fazla lisansa mı ihtiyacınız var? FastTrack avantajlarınızı kullanın</a></h3>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/understand-explore/introduction-to-microsoft-intune">Tüm Intune belgelerini</a> inceleyin.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-intro">Giriş</a>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Intune'un mobil cihazlar ve Windows bilgisayarları için nasıl cihaz, uygulama ve veri yönetim olanakları sağladığını öğrenin.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/understand-explore/introduction-to-microsoft-intune">Tüm giriş belgelerini</a> inceleyin.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
               <!-- <li>
                ...
                <li>
                    <a href="#manage-plan">Dağıtım planlama</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Hedefleri, amaçları ve zorlukları belirleme</h3>
                                            <p>Dağıtım sırasında yönetmeniz gereken hedefleri, amaçları ve zorlukları belirleyin.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Kullanım örneği senaryolarını tanımlama</h3>
                                            <p>Dağıtım kullanım örneği senaryolarınızı tanımlarken kullanacağınız bazı örnek kullanım örneklerini inceleyin. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Dağıtım planı geliştirme</h3>
                                            <p>Intune dağıtımınız için hedeflenen kuruluş gruplarını ve her gruba ait dağıtım zaman aralıklarını belirleyin.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/plan-design/introduction">Tüm dağıtım belgelerini</a> inceleyin.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-howto">Nasıl yapılır?</a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Koşullu erişim ilkesi oluşturma</h3>
                                            <p>Cihaz uyumuna bağlı olarak şirket içi Exchange için koşullu erişimi yapılandırın.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>MDM yetkilisini ayarlama</h3>
                                            <p>Mobil cihaz yönetimi yetkilisini belirlerken kullanabileceğiniz seçenekler hakkında bilgi edinin.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Cihaz profillerini yapılandırma</h3>
                                            <p>Intune'da cihaz yapılandırma profilleri oluşturmayı öğrenin.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Cihaz kısıtlamalarını yapılandırma</h3>
                                            <p>Intune'da cihaz kısıtlama ayarlarını yapılandırmayı öğrenin.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Uygulamaları yönetme</h3>
                                            <p>Uygulama ekleme, atama ve izleme adımlarını öğrenin.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Uygulama koruma ilkelerini oluşturma ve atama</h3>
                                            <p>Uygulama koruma ilkelerini oluşturma ve atamayı öğrenin.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/deploy-use/overview-of-device-and-app-lifecycles-in-microsoft-intune">Tüm nasıl yapılır belgelerini</a> inceleyin.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="#manage-troubleshoot">İzleme ve sorun giderme</a>
                    <ul id="manage-troubleshoot" class="cardsC">
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Intune önizlemesindeki tüm bilinen sorunlar hakkında bilgi edinin.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Uygulama dağıtımı sorunlarını giderme</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Cihaz kaydı sorunlarını giderme</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Cihaz profilleriyle ilgili sorunları giderme</h3>
                                            <p>Cihazlar için profil oluşturma sırasında karşılaştığınız sorunları çözün.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>E-posta profilleriyle ilgili sorunları giderme</h3>
                                            <p>E-posta profili oluşturma sırasında karşılaştığınız sorunları çözün.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">Tüm sorun giderme belgelerini</a> inceleyin.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Intune Uygulama SDK'sına genel bakış</h3>
                                            <p>Uygulamanızda Intune uygulama koruma ilkelerini etkinleştirmek için kullanabileceğiniz SDK'lar hakkında bilgi edinin.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Microsoft Graph’ta Intune ile çalışma</h3>
                                            <p>Intune denetimlerini ve ilkelerini yapılandırmak için Microsoft Graph API'lerini kullanın.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>İş kolu uygulamalarını MAM için hazırlama</h3>
                                            <p>Intune Uygulaması Sarmalama Aracı'nı veya Intune Uygulama SDK'sını kullanarak uygulamalarınızın mobil uygulama yönetim (MAM) ilkelerini kullanmasını sağlayın.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Tüm belgeleri mi arıyorsunuz? <a href="/intune/understand-explore/introduction-to-microsoft-intune">Tüm Intune belgelerini</a> inceleyin.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Intune hakkında geri bildirimde bulunun</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Microsoft Intune'u Twitter'da takip edin</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Forumda soru sorun ve yanıt verin</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Enterprise Mobility and Security Blogunu okuyun</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Intune hizmeti hakkında geri bildirimde bulunun</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Intune belgeleri hakkında geri bildirimde bulunun</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
