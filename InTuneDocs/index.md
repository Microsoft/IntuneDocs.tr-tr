            ...
            <ul id="manage">
                <li>
                    ...
                    <ul id="manage-featured" class="cardsC">
                        ...
                        <li>
                            <div>
                                <h3>Önerilen makaleler</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h3>Yeni makaleler</h3>
                            </div>
                        </li>
                        <li>
                            <div class="cardSize">
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="http://fasttrack.microsoft.com/ems">150'den fazla lisansa mı ihtiyacınız var? FastTrack avantajlarınızı kullanın</a></h3>
...
<!--                        <li>
        ...
        <li>
            <a href="#moreres">Diğer kaynaklar</a>
            <ul id="moreres">
                <li>
                    <a href="#moreres-all">Tümü</a>
