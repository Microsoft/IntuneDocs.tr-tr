...
**Sağlamak** Cihazda iOS ile ilgili belirtilmeyen bir sorun var.
...
**Sağlamak** Intune kiracınız yalnızca şirkete ait cihazlara izin verecek şekilde yapılandırılmıştır. 
...
**Sağlamak** Şirket Portalı uygulama güncel değil veya bozuk.
...
**Sağlamak** Kullanıcı cihaz kayıt sınırından daha fazla cihaz kaydetmeye çalışır.

#### <a name="resolution"></a>Çözüm
1. [Intune yönetim portalı](https://portal.azure.com/?Microsoft_Intune=1&Microsoft_Intune_DeviceSettings=true&Microsoft_Intune_Enrollment=true&Microsoft_Intune_Apps=true&Microsoft_Intune_Devices=true#blade/Microsoft_Intune_DeviceSettings/ExtensionLandingBlade/overview) > **cihazlar** > **tüm cihazlar**' ı açın ve kullanıcının kaydolduğu cihaz sayısını denetleyin.
    > [!NOTE]
...
2. **Yönetici** > **mobil cihaz yönetimi** > **kayıt kuralları** ' na gidin > cihaz kayıt sınırını denetleyin. Varsayılan olarak, sınır 15 olarak ayarlanır. 
...
**Sağlamak** Cihazı kaydetmeye çalışan kullanıcının geçerli bir Intune lisansı yok.
...
**Sağlamak** Cihazda bir yönetim profili zaten yüklü.

#### <a name="resolution"></a>Çözüm

1. **Genel**  cihaz > **yönetimi**> iOS cihazında ayarları açın.
2. Var olan yönetim profiline dokunun ve **yönetimi kaldır**' a dokunun.
3. Cihazı yeniden kaydedin.

### <a name="noenrollmentpolicy"></a>NoEnrollmentPolicy

**Sağlamak** Apple Anında İletilen Bildirim Servisi (APNs) sertifikası eksik, geçersiz veya zaman aşımına uğradı.
...
**Sağlamak** Intune 'da yapılandırılmış Apple Anında Iletilen bildirim hizmeti (APNs) sertifikasıyla ilgili bir sorun var.
...
### <a name="xpctypeerror-connection-invalid"></a>XPC_TYPE_ERROR bağlantısı geçersiz
...
**Sağlamak** Cihaz ve Apple DEP hizmeti arasında bir bağlantı sorunu var.
...
**Sağlamak** Kayıt profili, DEP belirteci Intune 'a yüklenmeden önce oluşturulur.
...
2. DEP ile yönetilen cihazları eşitler: Intune Portalı > **yönetici** > **mobil cihaz yönetimi** > **iOS** > aygıt kayıt programıŞimdi > **Eşitle**' ye açın. Apple'a bir eşitleme isteği gönderilir.
...
**Sağlamak** Multi-Factor Authentication (MFA) etkin. Şu anda MFA, DEP cihazlarında kayıt sırasında çalışmaz.
