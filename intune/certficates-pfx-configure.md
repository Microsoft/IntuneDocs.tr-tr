...
[SCEP sertifikalarını kullanmak](certificates-scep-configure.md), veya [PKCS sertifikaları Digicert PKI manager web hizmeti sorun](certificates-digicert-configure.md).
