...
#### <a name="myapps-available-for-managed-browser---822308-822303--"></a>Managed Browser için Uygulamaps <!--822308, 822303-->
...
#### <a name="sign-in-progress-indicator-in-android-company-portal---953374--"></a>Android Şirket Portalı 'de oturum açma işlemi göstergesi <!--953374-->
...
Artık, uygulama koruma ilkelerinin uygulanmadığı uygulamaları engellemek için uygulama tabanlı bir koşullu erişim ilkesi oluşturabilirsiniz. bu sayede [SharePoint Online](app-based-conditional-access-intune-create.md)'a erişebilirsiniz. Uygulama tabanlı koşullu erişim senaryosunda, Azure portal kullanarak SharePoint Online 'a erişmesini istediğiniz uygulamaları belirtebilirsiniz.

#### <a name="single-sign-on-support-from-the-company-portal-for-ios-to-outlook-for-ios---834012--"></a>İOS için Şirket Portalı iOS için Outlook 'a çoklu oturum açma desteği <!--834012-->
...
#### <a name="improved-status-messaging-in-the-company-portal-app-for-ios---744866--"></a>İOS için Şirket Portalı uygulamasında iyileştirilmiş durum iletileri <!--744866-->
...
### <a name="whats-new-in-the-public-preview-of-intune-in-the-azure-portal--736542--"></a>Azure portal Intune 'un genel önizlemesindeki yenilikler<!--736542-->
...
#### <a name="whats-coming-for-appx-in-intune-in-the-azure-portal----1000270---"></a>Azure portal Intune 'da appx 'e yönelik yenilikler <!-- 1000270 -->
...
#### <a name="apple-to-require-updates-for-application-transport-security---748318--"></a>Uygulama taşıma güvenliği için güncelleştirme gerektiren Apple <!--748318-->
...
- Lerde Şirket Portalı sekme başlıkları, BT tarafından tanımlanan markada renklendirilir.
- Gör **Uygulamalar** sekmesinde, **öne çıkan uygulamalar** ve **tüm uygulamalar** düğmeleri güncelleştirilir.
- Aramanız **Uygulamalar** sekmesinde, **arama** düğmesi bir kayan eylem düğmesidir.
- Uygulamalarda gezinme: **Tüm uygulamalar** görünümü daha kolay gezinme Için **öne çıkan**, **hepsi**ve **kategorilerin** sekmeli görünümünü gösterir.
- Support **Cihazlarım** ve **BT iletişim** sekmeleri, okunabilirliği artırmak için güncelleştirilir.
...
#### <a name="signing-script-for-windows-10-company-portal---941642--"></a>Windows 10 için imza betiği Şirket Portalı <!--941642-->
...
#### <a name="improved-support-for-android-users-based-in-china---720444--"></a>Çin 'e göre Android kullanıcıları için geliştirilmiş destek <!--720444-->
...
### <a name="modernizing-the-company-portal-website---753980--"></a>Şirket Portalı Web sitesini modernize etme <!--753980-->
...
#### <a name="group-migration-will-not-require-any-updates-to-groups-or-policies-for-ios-devices---898837--"></a>Grup Geçişi, iOS cihazları için Grup veya ilkelerde güncelleştirme gerektirmez <!--898837-->
...
### <a name="defaulting-to-managing-windows-desktop-devices-through-windows-settings---663050--"></a>Windows masaüstü cihazlarını Windows ayarları aracılığıyla yönetmeye ayarlanıyor <!--663050-->
...
#### <a name="improving-mobile-app-management-support-for-selective-wipe---581242--"></a>Seçmeli Temizleme için mobil uygulama yönetimi desteğini artırma <!--581242-->
Son kullanıcılara, "uygulama verileri silinmeden önceki çevrimdışı zaman aralığı" ilkesi nedeniyle verilerin otomatik olarak kaldırılması durumunda, iş veya okul verilerine yeniden erişim elde etmek için ek rehberlik sağlanacaktır.<!--, or the removal of the Intune Company Portal on Android.-->

#### <a name="company-portal-for-ios-links-open-inside-the-app---665954--"></a>Uygulama içinde açık olan iOS bağlantıları için Şirket Portalı <!--665954-->
...
#### <a name="new-mdm-server-address-for-windows-devices---893007--"></a>Windows cihazları için yeni MDM sunucu adresi <!--893007-->
...
* __Arabirim__: Öne çıkan uygulamalar ve tüm uygulamalar düğmeleri uygulamalar sekmesinde güncelleştirilmiştir. Arama düğmesi artık kayan eylem düğmesi şeklinde.
* __Gezinti__: Tüm uygulamalar, daha kolay gezinme için öne çıkan, hepsi ve kategorilerin sekmeli bir görünümünü gösterir.
* __Hizmet__: Cihazlarım ve BT BT sekmelerinde Iletişime geçerek okunabilirlik geliştirildi.

Önce ve sonra görüntülerini [UI güncelleştirmeleri sayfasında](whats-new-app-ui.md) bulabilirsiniz.

### <a name="associate-multiple-management-tools-with-the-microsoft-store-for-business---926135--"></a>Birden çok yönetim aracını Iş Microsoft Store ilişkilendir <!--926135-->
İş İçin Microsoft Mağazası uygulamalarını dağıtmak için birden fazla yönetim aracı kullanmanız durumunda önceden bunların yalnızca birini İş İçin Microsoft Mağazası ile ilişkilendirebiliyordunuz. Artık mağaza ile Intune ve Configuration Manager gibi birden fazla yönetim aracını ilişkilendirebilirsiniz. Ayrıntılar için bkz. [Microsoft Intune ile İş İçin Microsoft Mağazası'ndan satın aldığınız uygulamaları yönetme](windows-store-for-business.md).
...
Hem kayıtlı hem kayıtlı olmayan cihazlar için yeni uygulama koruma raporları eklenmiştir. Nasıl yapabilecekleriniz hakkında daha fazla bilgi edinin [Intune ile mobil uygulama yönetimi ilkelerini izleme](app-protection-policies-monitor.md).
...
Kullanıcıların cihazları Intune ile iletişimi kaybettiğinde, şirket kaynaklarına yeniden erişmeleri için kullanıcılara yeni sorun giderme adımları verebilirsiniz. Bkz. [Cihazlar etkin değil veya yönetim konsolu cihazlarla iletişim kuramıyor](troubleshoot-device-enrollment-in-intune.md#devices-are-inactive-or-the-admin-console-cant-communicate-with-them).
...
#### <a name="progress-bar-when-launching-the-company-portal-on-ios---665978--"></a>İOS üzerinde Şirket Portalı başlatılırken ilerleme çubuğu <!--665978-->
...
### <a name="public-preview-of-intune-in-the-azure-portal--736542--"></a>Azure portal Intune 'un genel önizlemesi<!--736542-->
...
__Kayıt sırasında Multi-Factor Authentication Azure portal taşınıyor__ <!--VSO 750545-->
