...
> [!NOTE]
> Sınıf uygulaması için Intune ayarları Intune 'da kullanımdan kalkmıştır. Bu makale, yalnızca Intune’da mevcut eğitim profilleri olan kullanıcılar için geçerlidir.
