...
### <a name="custom-device-settingsconfigurationcustom-settings-windows-holographicmd"></a>[Özel cihaz ayarları](../configuration/custom-settings-windows-holographic.md)
...
### <a name="configure-kiosk-modeconfigurationkiosk-settings-holographicmd"></a>[Bilgi noktası modunu yapılandırma](../configuration/kiosk-settings-holographic.md)
...
### <a name="device-restrictionsconfigurationdevice-restrictions-windows-holographicmd"></a>[Cihaz kısıtlamaları](../configuration/device-restrictions-windows-holographic.md)
...
### <a name="configure-vpnconfigurationvpn-settings-configuremd"></a>[VPN’i yapılandırma](../configuration/vpn-settings-configure.md)
...
### <a name="configure-wi-ficonfigurationwi-fi-settings-configuremd"></a>[Wi-Fi yapılandırma](../configuration/wi-fi-settings-configure.md)
