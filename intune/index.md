                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Azure portalında Intune</h3>
                                            <p>Microsoft Intune Azure portalında kullanılabilir. Yeni portalda cihazları ve uygulamaları yönetme hakkında bilgi edinin. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Intune kullanmaya başlayın</h3>
                                            <p>Temel bilgiler: Bir grup ve kullanıcı oluşturun. Cihazları kaydedin. İlke ve uygulamalar dağıtın.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Azure'daki Intune özelliğim nereye gitti?</h3>
                                            <p>Klasik konsolda Intune hakkında bilginiz varsa bu makale, Azure üzerinde Intune’da özelliğinizi bulmanıza yardımcı olur.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/what-is-intune">Tüm Intune belgelerini</a> inceleyin.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/what-is-intune">Tüm giriş belgelerini</a> inceleyin.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Hizmet tarafından desteklenen cihaz ve tarayıcılarla ilgili ayrıntılı bilgi edinin.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Dağıtım planlama, tasarım ve uygulama kılavuzu</h3>
                                            <p>Bir dağıtım planı geliştirin, tasarım oluşturun, Intune’u ekleyin ve bir üretim sürümünün piyasaya çıkma sürecini yönetin.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Geçiş kılavuzu</h3>
                                            <p>Bir üçüncü taraf MDM sağlayıcısından Intune’a geçiş ile ilgili çeşitli ayrıntılar hakkında bilgi sağlar.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune-classic/plan-design/introduction">Tüm dağıtım belgelerini</a> inceleyin.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune/device-enrollment">Tüm nasıl yapılır belgelerini</a> inceleyin.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="manage-troubleshoot" class="cardsC">
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Intune’da tüm bilinen sorunlar hakkında bilgi edinin.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3><a href="/intune-classic/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">Tüm sorun giderme belgelerini</a> inceleyin.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Tüm belgeleri mi arıyorsunuz? <a href="/intune-classic/understand-explore/introduction-to-microsoft-intune">Tüm Intune belgelerini</a> inceleyin.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
