...
| --- | --- |
| NDES Bağlayıcısı Kullanıcı arabiriminde Intune kiracı yönetici hesabıyla oturum açılamıyor. | Şirket içi sertifika Bağlayıcısı, Intune yönetim portalında etkin olmadığında bu durum oluşabilir. Bu sorunu çözmek için aşağıdaki yordamlardan birini kullanın: <br><br> Silverlight kullanıcı arabiriminden: <br> 1. [Intune yönetici portalında](https://admin.manage.microsoft.com)oturum açın. <br> 2. **yönetici**' yi seçin. <br> 3. **mobil cihaz yönetimi** > **sertifika bağlayıcısını**seçin. <br> 4. **Şirket Içi sertifika bağlayıcısını Yapılandır '** ı seçin. <br> 5. **sertifika bağlayıcısını etkinleştir** onay kutusunu seçin. <br> 6. **Tamam 'ı**seçin. <br><br> Azure portalı Kullanıcı Arabiriminden: <br> 1. [Azure Portal](https://portal.azure.com)oturum açın. <br> 2. Microsoft Intune gidin. <br> 3. **cihaz yapılandırma** > **sertifika yetkilisini**seçin. <br> 4. **Etkinleştir**'i seçin. <br><br> Silverlight kullanıcı arabiriminden veya Azure portal önceki adımları tamamladıktan sonra, NDES Bağlayıcısı Kullanıcı arabiriminde aynı Intune kiracı yönetici hesabıyla oturum açmayı deneyin. |
