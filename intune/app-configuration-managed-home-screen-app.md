...
| İzin ver-listelenen uygulamaları ayarlama | bundleArray | FALSE | Görünür uygulamalar kümesi için giriş ekranınızdaki cihazda yüklü uygulamalar arasında tanımlamanızı sağlar. Uygulamaları görünür hale getirmek istediğiniz uygulamaları, uygulama paketi adı girerek tanımlayabilir, örneğin com.android.settings ayarları erişilebilir giriş ekranında hale getirir. Uygulamalar bu, izin verilenler listesi bu bölümdeki zaten giriş ekranında görünür için cihazda yüklü. |
