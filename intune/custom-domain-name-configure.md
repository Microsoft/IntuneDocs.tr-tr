...
5. [Intune kayıtları için ek DNS kayıtları oluşturmanız](windows-enroll.md#simplify-windows-enrollment-without-azure-ad-premium)gerekebilir.
...
Kaydı Intune sunucularına yönlendiren bir DNS CNAME 'i oluşturarak, [Windows kaydını Azure AD Premium olmadan nasıl basitleştireceğinizi](windows-enroll.md#simplify-windows-enrollment-without-azure-ad-premium) öğrenin.
