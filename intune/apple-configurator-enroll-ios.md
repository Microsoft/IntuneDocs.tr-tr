...
5. **Apple Configurator Kayıt Profilleri** dikey penceresinde **Oluştur**’u seçin.
...
4. **Profil Ata** dikey penceresinde atamak istediğiniz **Yeni profili**, sonra da **Ata**yı seçin.
...
3. Profil dikey penceresinde, **Atanmış cihazlar**’ı ve ardından **Ata**’yı seçin.
...
1. Azure portalında oturum açın.
2. **Diğer Hizmetler** > **İzleme + Yönetim** > **Intune**’u seçin.
3. **Profili Dışarı Aktar** dikey penceresinde, kayıt profilini [Apple Configurator](https://itunes.apple.com/us/app/apple-configurator-2/id1037126344?mt=12)'a indirerek iOS cihazlarına doğrudan bir yönetim profili olarak iletin.
