...
| Lisans ataması, ' ' VPP lisansı kalmadı ' adlı Apple hatasıyla başarısız oldu (0x87d13b7e) | Bu davranış tasarıma göre yapılır. Bu sorunu çözmek için, ek VPP lisansları satın alın veya kullanıcılardan artık hedeflenmediğini bir lisans geri kazanın. |
