...
> [!IMPORTANT]
> Google 'ın Firebase bulut mesajlaşma 'yı (FCM) desteklemek için Android Şirket Portalı uygulamanızı en son sürüme güncelleştirmeniz gerekir. Daha fazla bilgi için bkz. [Android şirket portalı uygulamanızı en son sürüme güncelleştirme](../fundamentals/whats-new.md#update-your-android-company-portal-app-to-the-latest-version-).
