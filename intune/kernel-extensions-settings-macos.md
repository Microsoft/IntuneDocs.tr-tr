...
- **Kullanıcı geçersiz kılmaya Izin ver**: **Izin ver** , kullanıcıların, yapılandırma profilinde bulunmayan çekirdek uzantılarını onaylamasını sağlar. **Yapılandırılmadı** (varsayılan), kullanıcıların yapılandırma profilinde bulunmayan uzantılara izin vermesini engeller. Anlamı olarak yalnızca yapılandırma profiline eklenen uzantılara izin verilir.
