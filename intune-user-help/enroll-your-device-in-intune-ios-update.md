...
|Gördüğünüz|Açıklama|
|---|---|
|![Şirket Portalı oturum açma ekranında, alttaki "Oturum aç" düğmesi.](./media/ios-01-cp-enroll-1802.png)|Cihazınızda Şirket Portalı uygulamasını açın ve **Oturum Aç**’a dokunun.|
